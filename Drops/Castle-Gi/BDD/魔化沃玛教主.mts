...
//武器
drops.Add(new Drop("噬魂法杖", 900))
drops.Add(new Drop("CursedMaleficBow", 500))
drops.Add(new Drop("暗之修罗刀", 500))
drops.Add(new Drop("炼狱", 75))
drops.Add(new Drop("魔杖", 75))
drops.Add(new Drop("银蛇", 75))
drops.Add(new Drop("双极刀", 75))
drops.Add(new Drop("SilverBow", 75))
drops.Add(new Drop("井中月", 140))
drops.Add(new Drop("裁决之杖", 150))
drops.Add(new Drop("无极棍", 150))
drops.Add(new Drop("骨玉权杖", 150))
drops.Add(new Drop("暗黑刀", 150))
drops.Add(new Drop("MaleficBow", 150))
drops.Add(new Drop("龙牙", 220))
drops.Add(new Drop("怒斩", 220))
drops.Add(new Drop("逍遥扇", 220))
drops.Add(new Drop("冷月刀", 220))
drops.Add(new Drop("LitheBow", 220))
drops.Add(new Drop("暗之屠龙", 500))
drops.Add(new Drop("屠龙", 500))
drops.Add(new Drop("暗之噬魂", 500))
drops.Add(new Drop("暗之龙纹", 500))
drops.Add(new Drop("修罗刀", 900))
drops.Add(new Drop("FiendBow", 900))
drops.Add(new Drop("龙纹剑", 900))
