...
// 武器
drops.Add(new Drop("SilverBow", 1000000))
...
drops.Add(new Drop("LongBow", 150))
...
drops.Add(new Drop("LightLeatherArmour(男)", 400))
drops.Add(new Drop("LightLeatherArmour(女)", 400))
...
// 任务
drops.Add(new Drop("牛肋排", 6, 0, true))
