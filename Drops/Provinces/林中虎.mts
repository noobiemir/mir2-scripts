...
drops.Add(new Drop("ElementalShot", 5000))
drops.Add(new Drop("StoneTrap", 12000))
drops.Add(new Drop("ElementalBarrier", 15000))
drops.Add(new Drop("捕缚术", 6000))
drops.Add(new Drop("复活术", 20000))
drops.Add(new Drop("VampireShot", 45000))
drops.Add(new Drop("净化术", 5000))
drops.Add(new Drop("火龙气焰", 50000))
drops.Add(new Drop("分身术", 20000))
drops.Add(new Drop("火龙术", 12000))
...
drops.Add(new Drop("Concentration", 25000))
