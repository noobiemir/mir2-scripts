...
drops.Add(new Drop("弩弓", 15))
drops.Add(new Drop("八荒", 25))
drops.Add(new Drop("铁弓", 15))
drops.Add(new Drop("青铜剑", 15))
drops.Add(new Drop("革弓", 15))
