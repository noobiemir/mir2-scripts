...
drops.Add(new Drop("道术守护石(小)", 100))
drops.Add(new Drop("魔法守护石(小)", 100))
drops.Add(new Drop("生命守护石(小)", 100))
drops.Add(new Drop("攻击守护石(小)", 100))
...
drops.Add(new Drop("远古镰刀", 100, 0, true))
