...
drops.Add(new Drop("TemperedArmour(男)", 300))
drops.Add(new Drop("TemperedArmour(女)", 300))
...
drops.Add(new Drop("StuddedArmour(男)", 2000))
drops.Add(new Drop("StuddedArmour(女)", 2000))
