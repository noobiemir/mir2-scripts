...
drops.Add(new Drop("赤炼符轮", 375))
drops.Add(new Drop("骑士手镯", 85))

// 戒指
drops.Add(new Drop("奥玛环", 300))
drops.Add(new Drop("赤炼符戒", 320))
...
drops.Add(new Drop("束缚闪", 120))
drops.Add(new Drop("轻身步", 210))
drops.Add(new Drop("气功术", 40))
drops.Add(new Drop("万斤闪", 40))
drops.Add(new Drop("爆阱", 40))
drops.Add(new Drop("气流术", 45))
drops.Add(new Drop("吸血地闪", 45))
drops.Add(new Drop("吸血地精", 50))
drops.Add(new Drop("风弹步", 55))
drops.Add(new Drop("爆闪", 60))
drops.Add(new Drop("阴阳五行阵", 80))
drops.Add(new Drop("金刚术", 60))
drops.Add(new Drop("痹魔阱", 210))
drops.Add(new Drop("吸气", 120))
drops.Add(new Drop("无极真气", 75))
drops.Add(new Drop("邪爆闪", 210))
drops.Add(new Drop("群体治疗术", 65))
drops.Add(new Drop("毒魔闪", 210))
