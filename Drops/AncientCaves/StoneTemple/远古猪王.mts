...
drops.Add(new Drop("StuddedArmour(男)", 150))
drops.Add(new Drop("StuddedArmour(女)", 150))
...
drops.Add(new Drop("LightLeatherArmour(女)", 3))
drops.Add(new Drop("LightLeatherArmour(男)", 3))
