...
drops.Add(new Drop("气功术", 400))
drops.Add(new Drop("吸血地精", 500))
drops.Add(new Drop("爆闪", 1000))
drops.Add(new Drop("爆阱", 300))
drops.Add(new Drop("隐身术", 100))
drops.Add(new Drop("万斤闪", 2000))
