...
drops.Add(new Drop("CompoundBow", 160))
...
//头盔
drops.Add(new Drop("道士头盔", 240))
drops.Add(new Drop("骷髅头盔", 300))
drops.Add(new Drop("黄金头盔", 200))
drops.Add(new Drop("魔法头盔", 150))
drops.Add(new Drop("青铜头盔", 100))
drops.Add(new Drop("黄铜头盔", 200))

//项链
drops.Add(new Drop("灵魂项链", 5800))
...
drops.Add(new Drop("绿色项链", 5800))
drops.Add(new Drop("狂风项链", 5800))
drops.Add(new Drop("恶魔铃铛", 5800))

//手镯
drops.Add(new Drop("黑檀手镯", 300))
drops.Add(new Drop("夏普儿手镯", 400))
drops.Add(new Drop("坚固手套", 500))
drops.Add(new Drop("尽力手镯", 300))
drops.Add(new Drop("魔法手镯", 400))
drops.Add(new Drop("大手镯", 150))
drops.Add(new Drop("钢手镯", 150))
drops.Add(new Drop("银手镯", 150))
drops.Add(new Drop("小手镯", 80))

//戒指
drops.Add(new Drop("龙之戒指", 3000))
...
drops.Add(new Drop("古铜戒指", 50))
drops.Add(new Drop("铂金戒指", 3000))
drops.Add(new Drop("红宝石戒指", 3000))
...
//石头
drops.Add(new Drop("生命守护石(中)", 1400))
drops.Add(new Drop("魔力守护石(中)", 1400))
...
//技能书
drops.Add(new Drop("拔刀术", 400))
drops.Add(new Drop("召唤骷髅", 100))
drops.Add(new Drop("半月弯刀", 200))
drops.Add(new Drop("风身术", 400))
drops.Add(new Drop("瞬息移动", 100))
drops.Add(new Drop("Meditation", 400))
drops.Add(new Drop("SummonVampire", 500))
drops.Add(new Drop("DelayedExplosion", 1000))
drops.Add(new Drop("ExplosiveTrap", 300))
drops.Add(new Drop("隐身术", 100))
drops.Add(new Drop("ElementalShot", 2000))
drops.Add(new Drop("大火球", 84))
drops.Add(new Drop("攻杀剑术", 84))
drops.Add(new Drop("诱惑之光", 84))
drops.Add(new Drop("绝命剑法", 140))
drops.Add(new Drop("雷电术", 140))
drops.Add(new Drop("地狱火", 140))
drops.Add(new Drop("抗拒火环", 140))
drops.Add(new Drop("施毒术", 140))
drops.Add(new Drop("BackStep", 1400))
drops.Add(new Drop("灵魂火符", 84))
