...
drops.Add(new Drop("道士头盔", 24))
drops.Add(new Drop("黄金头盔", 20))
drops.Add(new Drop("魔法头盔", 15))
drops.Add(new Drop("青铜头盔", 10))
drops.Add(new Drop("黄铜头盔", 20))

// 项链
drops.Add(new Drop("恶魔铃铛", 580))
drops.Add(new Drop("灯笼项链", 20))
drops.Add(new Drop("灵魂项链", 580))
drops.Add(new Drop("狂风项链", 580))
drops.Add(new Drop("绿色项链", 580))
...
// 手镯
drops.Add(new Drop("夏普儿手镯", 40))
drops.Add(new Drop("黑檀手镯", 30))
drops.Add(new Drop("尽力手镯", 30))
...
// 技能书
drops.Add(new Drop("瞬息移动", 10))
drops.Add(new Drop("爆闪", 100))
drops.Add(new Drop("吸血地精", 50))
drops.Add(new Drop("气功术", 40))
drops.Add(new Drop("爆阱", 30))
drops.Add(new Drop("风身术", 40))
drops.Add(new Drop("拔刀术", 40))
drops.Add(new Drop("半月弯刀", 20))
drops.Add(new Drop("召唤骷髅", 10))
drops.Add(new Drop("隐身术", 10))
drops.Add(new Drop("万斤闪", 200))
drops.Add(new Drop("大火球", 8))
drops.Add(new Drop("攻杀剑术", 8))
drops.Add(new Drop("诱惑之光", 8))
drops.Add(new Drop("绝命剑法", 14))
drops.Add(new Drop("雷电术", 14))
drops.Add(new Drop("地狱火", 14))
drops.Add(new Drop("抗拒火环", 14))
drops.Add(new Drop("施毒术", 14))
drops.Add(new Drop("风弹步", 140))
drops.Add(new Drop("灵魂火符", 8))
