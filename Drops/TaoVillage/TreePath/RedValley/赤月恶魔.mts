...
drops.Add(new Drop("魔杖", 15))
drops.Add(new Drop("银蛇", 15))
drops.Add(new Drop("双极刀", 15))
drops.Add(new Drop("炼狱", 15))
drops.Add(new Drop("裁决之杖", 150))
...
//头盔
drops.Add(new Drop("黑铁头盔", 85))
drops.Add(new Drop("骷髅头盔", 10))
drops.Add(new Drop("道士头盔", 5))
drops.Add(new Drop("记忆头盔", 1000))
drops.Add(new Drop("勇士头盔", 100))

//项链
drops.Add(new Drop("狂风项链", 110))
drops.Add(new Drop("探测项链", 10000))
drops.Add(new Drop("绿色项链", 80))
drops.Add(new Drop("魔血项链", 50))
drops.Add(new Drop("灵魂项链", 80))
drops.Add(new Drop("记忆项链", 1000))
...
drops.Add(new Drop("生命项链", 15))
drops.Add(new Drop("天珠项链", 15))
drops.Add(new Drop("幽灵项链", 15))
...
drops.Add(new Drop("强效太阳水", 2))
drops.Add(new Drop("道力药水(小)", 5))
drops.Add(new Drop("攻击药水(小)", 5))
drops.Add(new Drop("疾风药水(小)", 5))
drops.Add(new Drop("太阳水", 2))
drops.Add(new Drop("万年雪霜", 5))
drops.Add(new Drop("万年雪霜", 5))
drops.Add(new Drop("苹果", 1))
drops.Add(new Drop("苹果", 1))
drops.Add(new Drop("万年雪霜", 5))
drops.Add(new Drop("万年雪霜", 5))
drops.Add(new Drop("魔法药水(小)", 5))
drops.Add(new Drop("太阳水", 2))
drops.Add(new Drop("太阳水", 2))
...
//宝石
drops.Add(new Drop("觉醒神珠", 60))
drops.Add(new Drop("集中神珠", 60))
drops.Add(new Drop("疾风神珠", 100))
drops.Add(new Drop("魔性神珠", 55))
drops.Add(new Drop("勇猛神珠", 55))
drops.Add(new Drop("仙界神珠", 55))
