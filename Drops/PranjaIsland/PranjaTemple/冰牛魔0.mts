...
// 石头
drops.Add(new Drop("攻击守护石(大)", 700))
drops.Add(new Drop("魔法守护石", 11000))
drops.Add(new Drop("攻击守护石", 11000))
drops.Add(new Drop("能力守护石(大)", 500))
drops.Add(new Drop("道术守护石", 11000))
drops.Add(new Drop("魔力守护石(大)", 400))
drops.Add(new Drop("生命守护石(大)", 400))
drops.Add(new Drop("道术守护石(大)", 700))
drops.Add(new Drop("魔法守护石(大)", 700))
