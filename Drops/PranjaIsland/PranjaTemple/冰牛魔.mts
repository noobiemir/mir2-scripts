...
// 石头
drops.Add(new Drop("攻击守护石(大)", 7000))
drops.Add(new Drop("魔法守护石", 110000))
drops.Add(new Drop("攻击守护石", 110000))
drops.Add(new Drop("能力守护石(大)", 5000))
drops.Add(new Drop("道术守护石", 110000))
drops.Add(new Drop("魔力守护石(大)", 4000))
drops.Add(new Drop("生命守护石(大)", 4000))
drops.Add(new Drop("道术守护石(大)", 7000))
drops.Add(new Drop("魔法守护石(大)", 7000))
...
// 技能书
drops.Add(new Drop("迷魂术", 19000))
drops.Add(new Drop("捕缚术", 19000))
drops.Add(new Drop("嗜血术", 19000))
