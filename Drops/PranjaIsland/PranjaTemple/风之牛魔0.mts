...
drops.Add(new Drop("LitheBow", 10000))
...
drops.Add(new Drop("StuddedArmour(女)", 700))
drops.Add(new Drop("StuddedArmour(男)", 700))
drops.Add(new Drop("修罗血衣(男)", 700))
drops.Add(new Drop("玄天宝衣(女)", 700))
drops.Add(new Drop("修罗血衣(女)", 700))
drops.Add(new Drop("火龙魔衣(女)", 700))
drops.Add(new Drop("火龙魔衣(男)", 700))
drops.Add(new Drop("鬼面甲胄(女)", 700))
drops.Add(new Drop("鬼面甲胄(男)", 700))
...
//工艺材料
drops.Add(new Drop("寒冰珠", 30))
drops.Add(new Drop("疾风珠", 30))
