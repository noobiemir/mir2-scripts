...
drops.Add(new Drop("破魂", 60))
drops.Add(new Drop("偃月", 60))

// 衣服
drops.Add(new Drop("重盔甲(女)", 200))
drops.Add(new Drop("StuddedArmour(女)", 1750))
drops.Add(new Drop("StuddedArmour(男)", 1750))
drops.Add(new Drop("修罗血衣(女)", 1750))
drops.Add(new Drop("修罗血衣(男)", 1750))
drops.Add(new Drop("玄天宝衣(女)", 1750))
drops.Add(new Drop("玄天宝衣(男)", 1750))
drops.Add(new Drop("火龙魔衣(女)", 1750))
drops.Add(new Drop("鬼面甲胄(女)", 1750))
drops.Add(new Drop("火龙魔衣(男)", 1750))
...
drops.Add(new Drop("鬼面甲胄(男)", 1750))
...
drops.Add(new Drop("魅力戒指", 1000))
drops.Add(new Drop("道德戒指", 1000))
...
// 石头
drops.Add(new Drop("攻击守护石(大)", 30000))
drops.Add(new Drop("道术守护石(大)", 30000))
drops.Add(new Drop("魔法守护石(大)", 30000))
