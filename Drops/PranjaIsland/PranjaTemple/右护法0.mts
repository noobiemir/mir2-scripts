...
drops.Add(new Drop("LitheBow", 170000))
...
//技能书
drops.Add(new Drop("圆月弯刀", 70000))
drops.Add(new Drop("猛毒剑气", 70))
drops.Add(new Drop("捕缚术", 70000))
drops.Add(new Drop("火龙气焰", 900000))
