...
drops.Add(new Drop("BowOfForce", 400))
...
drops.Add(new Drop("StuddedArmour(男)", 5))
drops.Add(new Drop("ScaledArmour(女)", 500))
drops.Add(new Drop("ScaledArmour(男)", 500))
...
drops.Add(new Drop("StuddedArmour(女)", 5))
