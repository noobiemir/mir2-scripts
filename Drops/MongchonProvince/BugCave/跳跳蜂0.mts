...
drops.Add(new Drop("修罗", 70))
drops.Add(new Drop("凝霜", 80))
...
//药水
drops.Add(new Drop("魔法药水(小)", 50))
drops.Add(new Drop("疾风药水(小)", 50))
...
drops.Add(new Drop("攻击药水(小)", 50))
drops.Add(new Drop("道力药水(小)", 50))
...
//工艺材料
drops.Add(new Drop("白线", 2))
drops.Add(new Drop("虫壳", 1))
