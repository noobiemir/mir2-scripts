...
// 武器
drops.Add(new Drop("祖玛无极棍", 500))
drops.Add(new Drop("ZumaFiendBow", 500))
drops.Add(new Drop("祖玛暗黑刀", 500))
drops.Add(new Drop("祖玛骨玉权杖", 500))
drops.Add(new Drop("祖玛裁决之杖", 500))
...
drops.Add(new Drop("万年雪霜", 24))
drops.Add(new Drop("金疮药(中量)", 2))
drops.Add(new Drop("强效太阳水", 16))
