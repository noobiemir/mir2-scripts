...
// 武器
drops.Add(new Drop("SilverBow", 340))
drops.Add(new Drop("ZumaFiendBow", 3000))
drops.Add(new Drop("祖玛暗黑刀", 3000))
drops.Add(new Drop("祖玛无极棍", 3000))
drops.Add(new Drop("祖玛骨玉权杖", 3000))
drops.Add(new Drop("祖玛裁决之杖", 3000))
drops.Add(new Drop("双极刀", 340))
drops.Add(new Drop("银蛇", 340))
drops.Add(new Drop("炼狱", 340))
drops.Add(new Drop("魔杖", 340))
drops.Add(new Drop("修罗", 20))
drops.Add(new Drop("LongBow", 4))
drops.Add(new Drop("墨铁刀", 4))
drops.Add(new Drop("降魔", 4))
drops.Add(new Drop("偃月", 4))
drops.Add(new Drop("斩马刀", 4))
drops.Add(new Drop("破魂", 4))
...
drops.Add(new Drop("TemperedArmour(男)", 200))
drops.Add(new Drop("TemperedArmour(女)", 200))
drops.Add(new Drop("战神盔甲(男)", 200))
drops.Add(new Drop("炎红战衣(女)", 200))
drops.Add(new Drop("LightLeatherArmour(女)", 50))
...
drops.Add(new Drop("LightLeatherArmour(男)", 50))
...
drops.Add(new Drop("蓝翡翠项链", 30))
drops.Add(new Drop("放大镜", 30))
drops.Add(new Drop("竹笛", 30))

// 手镯
drops.Add(new Drop("金手镯", 20))
drops.Add(new Drop("幽灵手套", 150))
