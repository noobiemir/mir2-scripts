...
// 武器
drops.Add(new Drop("祖玛无极棍", 5000))
drops.Add(new Drop("ZumaFiendBow", 5000))
drops.Add(new Drop("祖玛暗黑刀", 5000))
drops.Add(new Drop("祖玛骨玉权杖", 5000))
drops.Add(new Drop("祖玛裁决之杖", 5000))
...
drops.Add(new Drop("LightLeatherArmour(女)", 500))
...
drops.Add(new Drop("太阳水", 80))
drops.Add(new Drop("金疮药(大量)", 50))
drops.Add(new Drop("万年雪霜", 240))
drops.Add(new Drop("金疮药(中量)", 20))
drops.Add(new Drop("强效太阳水", 160))
