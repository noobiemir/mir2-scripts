...
drops.Add(new Drop("ZumaFiendBow", 170))
...
drops.Add(new Drop("SilverBow", 50))
...
drops.Add(new Drop("FiendBow", 280))
...
drops.Add(new Drop("LeatherArmour(女)", 5))
...
drops.Add(new Drop("LeatherArmour(男)", 5))
